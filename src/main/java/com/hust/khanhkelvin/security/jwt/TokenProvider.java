package com.hust.khanhkelvin.security.jwt;
...
public class TokenProvider implements InitializingBean {
    ...
    // tạo token từ thông tin người dùng đăng nhập (username, password)
    ...
    // lấy ra thông tin (username, password, role) của người dùng dựa vào token
